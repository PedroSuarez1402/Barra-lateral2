...
function onOpen() {
  ...
  SpreadsheetApp.getUi().createMenu('Modificacion')
  .addItem('Mostrar barra lateral','mostrarBarra')
  .addToUi();
...
{
  var barra = HtmlService.createHtmlOutputFromFile('BarraLateral').setTitle('Barra lateral modificacion apps scripts');
